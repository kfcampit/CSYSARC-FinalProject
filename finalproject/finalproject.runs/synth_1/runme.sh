...
HD_PWD='C:/Users/Kyle Campit/Documents/GitHub/CSYSARC-FinalProject/finalproject/finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SAP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SAP.tcl
